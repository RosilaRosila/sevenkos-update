...
<head>
  ...
  <style>
    section.hero-wrap.hero-wrap-2 {
      background-image: url('<?php echo base_url('asset') ?>/images/bg_1.jpg');
    }
  </style>
</head>
            ...
            <div class="p-2">
              <select class="form-control" name="kota">
                ...
                if ($k['filter_status'] == '1') {?>
                 <option value="<?php echo $k['kota']; ?>" <?= ($this->input->get('kota') == $k['kota']) ? 'selected' : ''; ?>><?php echo $k['kota']; ?></option>
              <?php  } 
              endforeach ?>
              </select>
            </div>
      ...
      <div class="row ftco-animate justify-content-center">
        ...
        <?php foreach ($sql as $kos) : ?>
          <div class="item" style="width:352px; margin: 1rem;">
            ...
            <?php } ?>
              <a href="<?= base_url(); ?>detail/<?= strtolower($kos->slug) ?>"><img src="<?= $kos->image_header ?>" fix width="352px" height="250">
