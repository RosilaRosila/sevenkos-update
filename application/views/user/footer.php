        ...
        <div class="row mb-5">
            <div class="col-md">
                <div class="ftco-footer-widget mb-4">
                    ...
                    <p>Bingung cari kos dengan area, harga, fasilitas, dan juga tipe kamar yang kamu mau? Temukan kos
                        pilihanmu hanya di SevenKos</p>
            ...
            <div class="col-md">
                <div class="ftco-footer-widget mb-4 ml-md-4">
                    ...
                    <ul class="list-unstyled">
                        <li><a href="<?php echo base_url() ?>Main_Back_User/semua_kos"><span
                                    class="fa fa-chevron-right mr-2"></span>Search Properties</a></li>
                    </ul>
                </div>
            </div>
            <div class="col-md">
                <div class="ftco-footer-widget mb-4 ml-md-4">
                    ...
                    <ul class="list-unstyled">
                        <li><a href="<?php echo base_url() ?>Main_Back_User/services"><span
                                    class="fa fa-chevron-right mr-2"></span>Services</a></li>
                    </ul>
                </div>
            </div>
            <div class="col-md">
                <div class="ftco-footer-widget mb-4">
                    ...
                    <ul class="list-unstyled">
                        <li><a href="<?php echo base_url() ?>Main_Back_User/about_us"><span
                                    class="fa fa-chevron-right mr-2"></span>About Us</a></li>
                        <li><a href="<?php echo base_url() ?>Main_Back_User/contact"><span
                    ...
                    <div class="block-23 mb-3">
                        <ul>
                            <li>
                                ...
                                <span class="text">
                                    Karangjambe, Gg. Arjuna No.59, Jaranan, Banguntapan, Kec.
                                    Banguntapan, Kabupaten Bantul, Daerah Istimewa Yogyakarta 55198
                                </span>
                            </li>
                            <li>
                                <a href="tel:(0274) 4534571">
                                    <span class="icon fa fa-phone"></span>
                                    <span class="text">(0274)
                                        4534571
                                    </span>
                                </a>
                            </li>
                            <!-- <li>
                              <a href="https://api.whatsapp.com/send?phone=02744534571" target="_blank"><span
                                        class="icon fa fa-phone"></span><span class="text">(0274) 4534571</span>
                                      </a>
                            </li> -->
                            <li>
                                <a href="mailto:cs@sevenkos.com">
                                    <span class="icon fa fa-envelope"></span>
                                    <span class="text">cs@sevenkos.com</span>
                                </a>
                            </li>
                        </ul>
                    </div>
            ...
            <div class="col-md-12 text-center">
                ...
                <p>
                    ...
                    document.write(new Date().getFullYear());
                        ...
                        aria-hidden="true"></i> by <a href="<?php echo base_url() ?>" target="_blank">SevenKos</a>
