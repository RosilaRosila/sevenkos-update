    ...
    <div class="row mb-5">
      <div class="col-md">
        <div class="ftco-footer-widget mb-4">
          ...
          <p>Bingung cari kos dengan area, harga, fasilitas, dan juga tipe kamar yang kamu mau? Temukan kos pilihanmu hanya di SevenKos</p>
      ...
      <div class="col-md">
        <div class="ftco-footer-widget mb-4 ml-md-4">
          ...
          <ul class="list-unstyled">
            <li><a href="<?php echo base_url() ?>Main_Front_User/semua_kos"><span class="fa fa-chevron-right mr-2"></span>Search Properties</a></li>
        </div>
      </div>
      <div class="col-md">
        <div class="ftco-footer-widget mb-4 ml-md-4">
          ...
          <ul class="list-unstyled">
            <li><a href="<?php echo base_url() ?>Main_Front_User/services"><span class="fa fa-chevron-right mr-2"></span>Services</a></li>
          </ul>
        </div>
      </div>
      <div class="col-md">
        <div class="ftco-footer-widget mb-4">
          ...
          <ul class="list-unstyled">
            <li><a href="<?php echo base_url() ?>Main_Front_User/about_us"><span class="fa fa-chevron-right mr-2"></span>About Us</a></li>
            <li><a href="<?php echo base_url() ?>Main_Front_User/contact"><span class="fa fa-chevron-right mr-2"></span>Contact</a></li>
          </ul>
        </div>
      </div>
      <div class="col-md">
    ...
    <div class="row">
      <div class="col-md-12 text-center">
        <p>
          ...
          </script> All rights reserved | This website is made with <i class="fa fa-heart" aria-hidden="true"></i> by <a href="<?php echo base_url() ?>Main_Front_User" target="_blank">SevenKos</a>
          <!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. -->
        </p>
      </div>
    </div>
