...
class Main_Back_User extends CI_Controller
{
	...
	public function view_konten_kos($slug = '')
	{
		...
		if (!empty($data_kos)) {
			...
			$data2['current_url'] = base_url(uri_string());
	...
	// {
	// 	$dataa = $this->User_model->getKos("where slug = '$slug'")->result_array();
	// 	$data3 = array(
	// 		'nama'				=> strip_tags($dataa[0]['nama']),
	// 		'id_kos'			=> $dataa[0]['id_kos'], //baru
	// 		'id_user'			=> $dataa[0]['id_user'],
	// 		'sisa_kamar'		=> $dataa[0]['sisa_kamar'],
	// 		'alamat'			=> $dataa[0]['alamat'],
	// 		'slug'				=> $dataa[0]['slug'],
	// 		'date'				=> $dataa[0]['date'],
	// 		'time'				=> $dataa[0]['time'],
	// 		'kota'				=> $dataa[0]['kota'],
	// 		'harga'				=> $dataa[0]['harga'],
	// 		'diskon'			=> $dataa[0]['diskon'],
	// 		'foto'				=> $dataa[0]['foto'],
	// 		'kategori'			=> $dataa[0]['kategori'],
	// 		'no_hp'				=> $dataa[0]['no_hp'],
	// 		'fullname'			=> $dataa[0]['fullname'],
	// 		'tipe'				=> $dataa[0]['tipe'],
	// 		'fasilitas'			=> $dataa[0]['fasilitas'],
	// 		'fasilitas_umum'	=> $dataa[0]['fasilitas_umum'],
	// 		'fasilitas_kamar_mandi'	=> $dataa[0]['fasilitas_kamar_mandi'],
	// 		'fasilitas_parkir'	=> $dataa[0]['fasilitas_parkir'],
	// 		'peraturan_kamar'	=> $dataa[0]['peraturan_kamar'],
	// 		'spesifikasi_kamar'	=> $dataa[0]['spesifikasi_kamar'],
	// 		'image_header'		=> $dataa[0]['image_header'],
	// 		'tempat'			=> $data_tempat,
	// 	);
	// }
